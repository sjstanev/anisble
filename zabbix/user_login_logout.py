...
# Create device
def create_device(auth_token, hostname = host_name, first_ip = ip_addr, platform = platform):
...
def create_devic_via_ansible(hostname = host_name, first_ip = ip_addr, platform = platform):
    ...
    # Create Device
    create_device(auth_token, hostname, first_ip, platform)
